      ...
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-2 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">Your Image on a <span className="bg-gradient-to-r from-green-500 to-amber-200 bg-clip-text px-2 text-transparent">Custom</span> Phone Case</h1>
            ...
            <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
              ...
              <div className="flex flex-col justify-between items-center sm:items-start">
                <div className="flex gap-0.5">
                  {Array(5).fill(<Star className="h-4 w-4 text-green-600 fill-green-600"/>)}
                </div>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
                <div className="relative md:max-w-xl">
                  <img src="/your-image.png" className="absolute w-40 lg:w-52 left-56 -top-20 select-none hidden sm:black lg:hidden"/>
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
                <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                  <div className="flex gap-0.5 mb-2">
                    {Array(5).fill(<Star className="h-5 w-5 text-green-600 fill-green-600"/>)}
                  </div>
                ...
                <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                  ...
                  <div className="text-lg leading-8">
                    <p>
                      ...
                      heavy scratchmarks on all of my last phone cases. This one, besides a barely noticeable
